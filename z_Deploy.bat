...
@ROBOCOPY %cd% "%cd%\GtL-bin\execute" *.txt *.png *.ttf *.ogg /MIR /XD dirs "%cd%\GtL" "%cd%\GtL-bin" "%cd%\.github" "%cd%\.git" "%cd%\bin" "%cd%\builds" "%cd%\documentation" "%cd%\obj" "%cd%\media"
...
@ROBOCOPY %cd% "%cd%\GtL\execute" *.txt *.png *.ttf *.ogg /MIR /XD dirs "%cd%\GtL" "%cd%\GtL-bin" "%cd%\.github" "%cd%\.git" "%cd%\bin" "%cd%\builds" "%cd%\documentation" "%cd%\obj" "%cd%\media"
@cd GtL-bin
@rem zip it up...
